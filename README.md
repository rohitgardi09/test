...
// ============================================================
// STEP 1 — DB SQL (He DB madhe run kara)
// ============================================================
...
// ============================================================
// STEP 2 — ExceptionLog.java (entity package madhe banvaa)
// ============================================================
...
public class ExceptionLog {
    ...
    @Column(name = "stacktrace", length = 5000)
...
class ExceptionLogId implements Serializable {
...
// ============================================================
// STEP 3 — ExceptionLogRepository.java (repository package madhe banvaa)
// ============================================================
...
// ============================================================
// STEP 4 — ExceptionLogServiceImpl.java (service package madhe banvaa)
// ============================================================
...
// ============================================================
// STEP 5 — YourExistingService.java (tumchya existing service madhe he changes kara)
// ============================================================
...
public class YourExistingService {
    ...
    public YourExistingService(ExceptionLogService exceptionLogService) {
        this.exceptionLogService = exceptionLogService;
    }

    // User trigger karato tevha
    public void processPayment(String merchantId) {
        try {
            // tumcha existing code ithe
        } catch (Exception e) {
            exceptionLogService.logException(e, merchantId, "processPayment failed");
        }
    }

    // Kafka trigger karato tevha
    public void handleKafkaEvent(String payload, String merchantId) {
        try {
            // tumcha existing code ithe
        } catch (Exception e) {
            exceptionLogService.logException(e, merchantId, "handleKafkaEvent failed");
        }
    }

    // Scheduler trigger karato tevha
    public void runScheduledJob() {
        try {
            // tumcha existing code ithe
        } catch (Exception e) {
            exceptionLogService.logException(e, null, "runScheduledJob failed");
        }
    }
}
